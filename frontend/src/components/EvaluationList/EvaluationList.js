      ...
      <Card>
        <CardText>
          <Table
            ...
            {...this.props}
          >
            <Column header={<Cell>ID</Cell>} cell={<EvaluationLinkCell data={evaluations} col="ID" />} width={150} />
            <Column header={<Cell>Job</Cell>} cell={<JobLinkCell data={evaluations} />} flexGrow={2} width={200} />
            <Column header={<Cell>Type</Cell>} cell={<TextCell data={evaluations} col="Type" />} width={150} />
            <Column header={<Cell>Priority</Cell>} cell={<TextCell data={evaluations} col="Priority" />} width={150} />
