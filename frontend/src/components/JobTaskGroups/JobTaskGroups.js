              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHeaderColumn key="count" style={{ width: 40, textAlign: "right" }}>
                      Count
                    </TableHeaderColumn>
                    <TableHeaderColumn key="actions" style={{ width: 50 }}>
                      Actions
                    </TableHeaderColumn>
                  </TableRow>
                </TableHeader>
            ...
            <CardText>
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHeaderColumn key="name">Name</TableHeaderColumn>
                    <TableHeaderColumn key="driver" style={{ width: 80 }}>
                      Driver
                    </TableHeaderColumn>
                    <TableHeaderColumn key="cpu" style={{ width: 80 }}>
                      CPU
                    </TableHeaderColumn>
                    <TableHeaderColumn key="memory" style={{ width: 80 }}>
                      Memory
                    </TableHeaderColumn>
                    <TableHeaderColumn key="disk" style={{ width: 80 }}>
                      Disk
                    </TableHeaderColumn>
                    <TableHeaderColumn key="constraints" style={{ width: 80 }}>
                      Constraints
                    </TableHeaderColumn>
                  </TableRow>
                </TableHeader>
