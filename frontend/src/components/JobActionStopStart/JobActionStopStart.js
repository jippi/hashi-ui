...
class JobActionStopStart extends React.Component {
  handleSubmit = () => {
  ...
  componentWillUpdate(nextProps) {
    if (nextProps.jobDialog === "stop_start") {
      this.props.dispatch({ type: NOMAD_JOB_HIDE_DIALOG })
      this.props.dispatch({ type: NOMAD_RESTART_JOB, payload: this.props.job.ID })
    }
  }
...
JobActionStopStart.propTypes = {
  dispatch: PropTypes.func.isRequired,
  job: PropTypes.object.isRequired,
  jobDialog: PropTypes.string
}

export default connect(mapStateToProps)(JobActionStopStart)
