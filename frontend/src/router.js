...
const NomadAllocationFiles = Loadable({
	...
	loading: MyLoadingComponent,
	loader: () =>
		import(/* webpackChunkName: "nomad-allocation-files" */ "./components/AllocationFiles/AllocationFiles")
})
...
const NomadAllocationStats = Loadable({
	...
	loading: MyLoadingComponent,
	loader: () =>
		import(/* webpackChunkName: "nomad-allocation-stats" */ "./components/AllocationStats/AllocationStats")
})
...
const AppRouter = ({ history }) => (
	<Router history={history}>
		<Route path="/" component={App}>
			...
			<Route path="/consul/:region/services/:name/:key/:value" component={ConsulServices} />
			// Nomad
			...
			<Route path="/nomad/:region/allocations/:allocId" component={NomadAllocation}>
				...
				/>
				<Route
					path="/nomad/:region/allocations/:allocId/files"
					component={NomadAllocationFiles}
					query={{ path: "" }}
				/>
